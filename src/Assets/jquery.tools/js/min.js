...
}function T(b, a) {function j(a, t, c) {
    o = a;
    z = a.getFullYear();
    B = a.getMonth();
    A = a.getDate();
...
}function A(c, b) {function e(a, d, f, e) {
...
}function q(b) {function a() {
    return this.getAttribute("type") == b
}
    a.key = '[type="' + b + '"]';
    return a
}function n(b, a, f) {function p(a, b, e) {
        ...
        l = {
            "default": [function (b) {
                ...
                c.each(b, function (b, d) {
                    ...
                    var g = e.data("msg.el");
                    g || (g = c(a.message).addClass(a.messageClass).appendTo($(e).parent('div')), e.data("msg.el", g));
                    g.css({
                        visibility: "hidden"
                    }).find("p").remove();
