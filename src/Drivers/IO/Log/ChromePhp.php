...
class ChromePhp
{
    ...
    {
        $Call['Tags'] = isset($Call['Tags'])? $Call['Tags']: null;

        switch(isset($Call['Type'])? $Call['Type']: null)
        {
            case 'Error':
                ChromePhp::error($Call['Data'], $Call['Tags']);
            break;

            case 'Begin':
                ChromePhp::group($Call['Data'], $Call['Tags']);
            break;

            case 'End':
                ChromePhp::groupEnd($Call['Data'], $Call['Tags']);
            break;
