<?php
    ...
    setFn('Run', function ($Call) {
        ...
        if (isset($Call['API']['Request']['Service'])) {
                        ...
                        if ($Enabled) {
                            ...
                            if ($Call['API']['Response']['Access']) {
                                ...
                                if (F::Environment() == 'Development') {
                                    $Call = F::Dot(
                                        $Call,
                                        'HTTP.Headers.X-Codeine-API:',
                                        $Call['API']['Request']['Service'] . ':' . $Call['API']['Request']['Method']
                                    );
                                }
                            } else {
            ...
            F::Log(
                'API *' . $Call['API']['Request']['Service'] . ':' . $Call['API']['Request']['Method'] . '* finished',
                LOG_INFO,
                'Developer'
            );
            F::stopColor();
