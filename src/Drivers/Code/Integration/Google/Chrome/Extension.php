<?php
    ...
    setFn('Generate.Manifest', function ($Call) {
        ...
        // $Call = F::CopyDot($Call, 'Version.Project','Integration.Google.Chrome.Extension.Manifest.Template.version');
        $Call = F::CopyDot($Call, 'Project.Title', 'Integration.Google.Chrome.Extension.Manifest.Template.name');
        $Call = F::CopyDot(
            $Call,
            'Project.Title',
            'Integration.Google.Chrome.Extension.Manifest.Template.browser_action.default_title'
        );
        $Call = F::CopyDot(
            $Call,
            'Project.Description.Short',
            'Integration.Google.Chrome.Extension.Manifest.Template.description'
        );
