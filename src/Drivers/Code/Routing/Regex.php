<?php
    ...
    setFn('Route', function ($Call) {
        ...
        if (isset($Call['Regex'])) {
            ...
            foreach ($Call['Regex'] as $Name => $Call['Routing']['Rule']) {
                ...
                if (preg_match($Call['Routing']['Rule']['Match'], $Call['Routing']['URL'], $Matches)) {
                    ...
                    $Call['Routing']['Rule'] = F::Map(
                        $Call['Routing']['Rule'],
                        function (&$Key, &$Value, $Data, $FullKey, &$Array) use ($Matches) {
        ...
        if (isset($Selected)) {
            F::Log(
                'Rule *' . $Selected . '* selected with weight *' . $Weight . '* after ' . ($Call['Routing']['Rules Checked'] . ' of ' . sizeof(
                        $Call['Regex']
                    )),
                LOG_INFO
            );
