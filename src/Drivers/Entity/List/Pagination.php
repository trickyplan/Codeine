    ...
    setFn('beforeList', function ($Call) {
        ...
        if (isset($Call['Limit'])) {
            ...
            if (isset($Call['Count']) && !empty($Call['Count'])) {
                ...
                $Call['Pagination']['CountOfPages'] = ceil(
                    $Call['Pagination']['Count'] / $Call['Pagination']['ElementsPerPage']
                );
                ...
                if (isset($Call['Page'])) {
                    if (empty($Call['Page'])) {
                        ...
                        if ($Call['Page'] > $Call['Pagination']['Limits']['CountOfPages']) {
                            ...
                            F::Log(
                                'Page number (*' . $Call['Page'] . '*) *capped* to *' . $Call['Pagination']['Limits']['CountOfPages'] . '*',
                                LOG_INFO,
                                'Performance'
                            );
                        }
                        ...
                        if ($Call['Page'] > $Call['Pagination']['CountOfPages']) {
                            F::Log(
                                'Page number (*' . $Call['Page'] . '*) is more than count of pages (*' . $Call['Pagination']['CountOfPages'] . '*)',
                                LOG_INFO,
                                'Performance'
                            );
                            $Call = F::Apply(
                                ...
                                [
                                    'Redirect' => preg_replace(
                                        '@/page(\d+)@',
                                        '/page' . $Call['Pagination']['CountOfPages'],
                                        $Call['HTTP']['URL']
                                    )
                                ]
                            );
                ...
                F::Log(
                    'Elements *' . $Call['Pagination']['Elements']['From'] . '-'
                ...
                if ($Call['Pagination']['CountOfPages'] > 100) {
                    $Call['Pagination']['CountOfPages'] = 100;
                } // FIXME
            }
        }
