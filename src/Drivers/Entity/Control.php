<?php
    ...
    setFn('Overview', function ($Call) {
        ...
        $Call['Metrics']['Created']['Total'] = F::Run(
            'Entity',
            'Count',
            ['Entity' => $Call['Bundle'], 'No Where' => true]
        );
        $Call['Metrics']['Created']['Today'] = F::Run(
            'Entity',
            'Count',
            [
                'Entity' => $Call['Bundle'],
        ...
        $Call['Metrics']['Created']['Hour'] = F::Run(
            'Entity',
            'Count',
            [
                'Entity' => $Call['Bundle'],
        ...
        $Call['Metrics']['Created']['Minute'] = F::Run(
            'Entity',
            'Count',
            [
                'Entity' => $Call['Bundle'],
        ...
        $Call['Metrics']['Created']['Second'] = F::Run(
            'Entity',
            'Count',
            [
                'Entity' => $Call['Bundle'],
    ...
    setFn('List', function ($Call) {
        ...
        return F::Apply(
            ...
            'Do',
            $Call,
            ['Entity' => $Call['Bundle'], 'No Where' => true, 'Scope' => 'Control']
        );
    });
    ...
    setFn('Delete', function ($Call) {
        ...
        $Call = F::Apply('Entity.Delete', 'Before', $Call, [
            'Entity' => $Call['Bundle'],
            'Scope' => 'Control'
        ]);

        $Call = F::Apply('Entity.Delete', 'Do', $Call, [
            'Entity' => $Call['Bundle'],
            'Scope' => 'Control'
        ]);
