<?php
    ...
    setFn('Title', function ($Call) {
        if (isset($Call['View']['HTML']['Title'])) {
            if (preg_match($Call['Meta']['Pattern']['Title'], $Call['Output'])) {
                F::Log(
                    '*' . $Call['Meta']['Pattern']['Title'] . '* tag is deprecated. Use *codeine-seo-title* instead',
                    LOG_WARNING,
                ...
                if (isset($Call['View']['HTML']['Title'][count($Call['View']['HTML']['Title']) - 1])) {
                    $Call['View']['HTML']['Header RAW'] = $Call['View']['HTML']['Title'][count(
                        $Call['View']['HTML']['Title']
                    ) - 1];
                    $Call['View']['HTML']['Header'] = strip_tags(
                        $Call['View']['HTML']['Title'][count($Call['View']['HTML']['Title']) - 1],
                        '<codeine-locale><codeine-key>'
                    );
                }
                ...
                $Call['View']['HTML']['Title'] = implode(
                    $Call['Meta']['Title']['Delimiter'],
                    $Call['View']['HTML']['Title']
                );
                $Call['View']['HTML']['Title'] = html_entity_decode(
                    strip_tags($Call['View']['HTML']['Title'], '<codeine-locale><codeine-key>')
                );
                $Call['View']['HTML']['Title'] =
    ...
    setFn('Keywords', function ($Call) {
        if (preg_match($Call['Meta']['Pattern']['Keywords'], $Call['Output'])) {
            F::Log(
                '*' . $Call['Meta']['Pattern']['Keywords'] . '* tag is deprecated. Use *codeine-seo-keyword* instead',
                LOG_WARNING,
                ['Developer', 'Deprecated']
            );
    ...
    setFn('Description', function ($Call) {
        if (preg_match($Call['Meta']['Pattern']['Description'], $Call['Output'])) {
            F::Log(
                '*' . $Call['Meta']['Pattern']['Description'] . '* tag is deprecated. Use *codeine-seo-description* instead',
                LOG_WARNING,
                ['Developer', 'Deprecated']
            );
