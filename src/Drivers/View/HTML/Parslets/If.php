        ...
        foreach ($Call['Parsed']['Value'] as $IX => $Match) {
            ...
            if (empty($Call['Parsed']['Options'][$IX])) {
                ...
                if (isset($Call['Parsed']['Options'][$IX]['lt'])) {
                    $Decision = ((float)preg_replace(
                            '/,/',
                            '.',
                            $Value
                        ) < (float)$Call['Parsed']['Options'][$IX]['lt']);
                }
                ...
                if (isset($Call['Parsed']['Options'][$IX]['gt'])) {
                    $Decision = ((float)preg_replace(
                            ...
                            '.',
                            $Value
                        ) > (float)$Call['Parsed']['Options'][$IX]['gt']);
                }
                ...
                if (isset($Call['Parsed']['Options'][$IX]['lte'])) {
                    $Decision = ((float)preg_replace(
                            ...
                            '.',
                            $Value
                        ) <= (float)$Call['Parsed']['Options'][$IX]['lte']);
                }
                ...
                if (isset($Call['Parsed']['Options'][$IX]['gte'])) {
                    $Decision = ((float)preg_replace(
                            ...
                            '.',
                            $Value
                        ) >= (float)$Call['Parsed']['Options'][$IX]['gte']);
                }
