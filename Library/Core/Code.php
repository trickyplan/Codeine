...
final class Code extends Core
{
    ...
    public static function Initialize()
    {
        ...
        self::$_Contracts['Default'] =  Data::Read(
                array('Point' => 'Contract',
                      'Where' => array('ID' => 'Default')), Core::Kernel);
    }
    ...
    public static function LoadContract($Call, $Mode = Core::Kernel)
    {
        if (!isset(self::$_Contracts[$Call['N']][$Call['F']]))
        {
            ...
            if (isset($Call['D']))
            {
                $DriverContract = Data::Read(array('Point' => 'Contract',
                                                  'Where' => array('ID' => $Call['N'].'/'.$Call['D']), Core::Kernel));
    ...
    public static function Run($Call, $Mode = Core::User, $Runner = null, $Executor = null)
    {
        self::$Counters['Call']++;
        ...
        //    self::Run($Call['Contract']['Hook']['beforeRun'], Core::User, 'Multi');
        ...
        //    self::Run($Call['Contract']['Hook']['afterRun'], Core::User, 'Multi');
            ...
            if (isset($Call['Contract']['Return']['Filter']))
                $Return = self::Run(
                    array(
                         'Calls' => array_merge(
                             $Return,
                             $Call['Contract']['Return']['Filter'])), Core::User,
                    'Chain');
